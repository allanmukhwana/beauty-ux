		...
		<div class="notice updated is-dismissible a11y-notice a11y-install-elementor">
			<div class="a11y-notice-inner">
				...
				<div class="a11y-notice-content">
					<h3><?php esc_html_e( 'Do You Like One Click Accessibility? You\'ll Love Elementor!', 'BeautyUX-accessibility' ); ?></h3>
					<p><?php esc_html_e( 'Create high-end, pixel perfect websites at record speeds. Any theme, any page, any design. The most advanced frontend drag & drop page builder.', 'BeautyUX-accessibility' ); ?>
						<a href="https://elementor.com/?utm_source=accessibility&utm_medium=wp-dash&utm_campaign=notice" target="_blank"><?php esc_html_e( 'Learn more about Elementor', 'BeautyUX-accessibility' ); ?></a>.</p>
				</div>

				<div class="a11y-install-now">
					<a class="button a11y-install-button" href="<?php echo $install_url; ?>"><i class="dashicons dashicons-download"></i><?php esc_html_e( 'Install Now For Free!', 'BeautyUX-accessibility' ); ?></a>
				</div>
			</div>
		</div>
		<?php
	...
	public function admin_footer_text( $footer_text ) {
		...
		if ( in_array( $current_screen->id, array( self::SETTINGS_SLUG, self::TOOLBAR_SLUG ) ) ) {
			$footer_text = sprintf(
				...
				__( 'Enjoyed %1$s? Please leave us a %2$s rating. We really appreciate your support!', 'BeautyUX-accessibility' ),
				'<strong>' . __( 'One Click Accessibility', 'BeautyUX-accessibility' ) . '</strong>',
				'<a href="https://wordpress.org/support/plugin/BeautyUX-accessibility/reviews/?filter=5#new-post" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a>'
			);
		}
